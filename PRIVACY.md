...
- Your bills, their amounts and their due dates
- Your routines and what a normal day costs you
...
The widget reads the same data stored on your device and displays it on your home screen. If you would rather not show amounts there, turn on **Hide amounts** in Rules and the widget will show ••• instead.
...
**The backup file contains your financial history in readable form.** Treat it like a bank statement: keep it somewhere private, and think before sharing it.

Restoring a backup reads the file you pick and replaces the data in the app. That happens entirely on your device.
